...
class IMGParser:
    ...
    def run(self):
        ...
        intialTracbarVals = [14,61,11,100]
        intialCarRef = 0
    
        ctrl_lat = purePursuit(lfd=0.8)  
        
        widthTop = float(intialTracbarVals[0])
        heightTop = float(intialTracbarVals[1])
        widthBottom = float(intialTracbarVals[2])
        heightBottom = float(intialTracbarVals[3])
        src = np.float32([(widthTop/100, heightTop/100), (1-(widthTop/100), (heightTop/100)),
                        (widthBottom/100, heightBottom/100), (1-(widthBottom/100), heightBottom/100)])
